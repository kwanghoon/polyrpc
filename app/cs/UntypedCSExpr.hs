...
{-  | LocApp Value Type [Location] -}
  | Prim PrimOp [LocationRep] {- [Location] [Type] -} [Value]   
...
data Value =
  ...
  | Lit Literal
  | Tuple [Value]
  | Constr String [LocationRep] {- [Location] [Type] -} [Value] {- [Type] -}
...
data CodeName =
    CodeName String [LocationRep] {- [Location] [Type] -}
    deriving (Show, Typeable, Data)
